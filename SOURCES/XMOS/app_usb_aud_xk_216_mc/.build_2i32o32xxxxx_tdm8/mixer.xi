...
static int samples_from_host_streams[32];
...
# 806 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/mixer/mixer.xc"
    for (int i=0;i<32;i++)
    {
      asm volatile("stw %0, %1[%2]"::"r"(32 + i),"r"(samples_to_host_map),"r"(i));
    }
