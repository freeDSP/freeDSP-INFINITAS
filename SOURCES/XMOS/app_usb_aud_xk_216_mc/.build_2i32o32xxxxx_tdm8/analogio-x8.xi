# 1 "../src/extensions/analogio-x8.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 141 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/extensions/analogio-x8.xc" 2
...
# 9 "../src/extensions/analogio-x8.xc" 2
...
int clz(unsigned x);
# 10 "../src/extensions/analogio-x8.xc" 2
...
# 11 "../src/extensions/analogio-x8.xc" 2
...
# 29 "/Applications/XMOS_xTIMEcomposer_Community_14.3.3/target/include/stdio.h" 3
...
# 30 "/Applications/XMOS_xTIMEcomposer_Community_14.3.3/target/include/stdio.h" 2 3
...
# 46 "/Applications/XMOS_xTIMEcomposer_Community_14.3.3/target/include/stdio.h" 2 3
...
# 12 "../src/extensions/analogio-x8.xc" 2
...
# 13 "../src/extensions/analogio-x8.xc" 2
...
# 14 "../src/extensions/analogio-x8.xc" 2
...
# 16 "../src/extensions/analogio-x8.xc" 2
...
# 17 "../src/extensions/analogio-x8.xc" 2
# 1 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_i2c_shared/src/i2c_shared.h" 1
# 11 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_i2c_shared/src/i2c_shared.h"
...
# 18 "../src/extensions/analogio-x8.xc" 2
...
# 19 "../src/extensions/analogio-x8.xc" 2
...
# 28 "../src/extensions/analogio-x8.xc" 2
# 1 "../src/extensions/ak5558.h" 1
# 29 "../src/extensions/analogio-x8.xc" 2
# 1 "../src/extensions/analogio-x8.h" 1
# 16 "../src/extensions/analogio-x8.h"
void configAnalogIOx8( void );
# 30 "../src/extensions/analogio-x8.xc" 2
...
int AKM_i2c_shared_master_read_reg(struct r_i2c &i2cPorts, int device, int reg_addr, unsigned char data[], int nbytes);
int AKM_i2c_shared_master_write_reg(struct r_i2c &i2cPorts, int device, int reg_addr, const unsigned char data[], int nbytes);
# 56 "../src/extensions/analogio-x8.xc"
...
int AKM_i2c_shared_master_read_reg(struct r_i2c &i2cPorts, int device, int reg_addr,
    unsigned char data[], int nbytes)
{
    int retval;
...
int AKM_i2c_shared_master_write_reg(struct r_i2c &i2cPorts, int device, int reg_addr,
    const unsigned char data[], int nbytes)
{
    int retval;
    swlock_acquire(i2c_swlock);
...
void configAnalogIOx8( void )
{
    ...
    { unsigned char data_w[1]; data_w[0] = 0b00000000; AKM_i2c_shared_master_write_reg(r_i2c, (0x22), (0x01), data_w, 1);};
    ...
    { unsigned char data_w[1]; data_w[0] = 0b00110001; AKM_i2c_shared_master_write_reg(r_i2c, (0x22), (0x02), data_w, 1);};




    { unsigned char data_w[1]; data_w[0] = 0b01000000; AKM_i2c_shared_master_write_reg(r_i2c, (0x22), (0x03), data_w, 1);};
    ...
    { unsigned char data_w[1]; data_w[0] = 0b00000000; AKM_i2c_shared_master_write_reg(r_i2c, (0x22), (0x04), data_w, 1);};
    ...
    { unsigned char data_w[1]; data_w[0] = 0b00000000; AKM_i2c_shared_master_write_reg(r_i2c, (0x22), (0x05), data_w, 1);};





    { unsigned char data_w[1]; data_w[0] = 0b00000001; AKM_i2c_shared_master_write_reg(r_i2c, (0x22), (0x01), data_w, 1);};
# 297 "../src/extensions/analogio-x8.xc"
    { unsigned char data_w[1]; data_w[0] = 0b00000100; AKM_i2c_shared_master_write_reg(r_i2c, (0x20), (0x00), data_w, 1);};
    ...
    { unsigned char data_w[1]; data_w[0] = 0b00100010; AKM_i2c_shared_master_write_reg(r_i2c, (0x20), (0x01), data_w, 1);};
# 316 "../src/extensions/analogio-x8.xc"
    { unsigned char data_w[1]; data_w[0] = 0b00000000; AKM_i2c_shared_master_write_reg(r_i2c, (0x20), (0x02), data_w, 1);};
# 327 "../src/extensions/analogio-x8.xc"
    { unsigned char data_w[1]; data_w[0] = 0b00000000; AKM_i2c_shared_master_write_reg(r_i2c, (0x20), (0x05), data_w, 1);};





    { unsigned char data_w[1]; data_w[0] = 0b00000011; AKM_i2c_shared_master_write_reg(r_i2c, (0x20), (0x07), data_w, 1);};





    { unsigned char data_w[1]; data_w[0] = 0b00000000; AKM_i2c_shared_master_write_reg(r_i2c, (0x20), (0x07), data_w, 1);};
# 348 "../src/extensions/analogio-x8.xc"
    { unsigned char data_w[1]; data_w[0] = 0b10001101; AKM_i2c_shared_master_write_reg(r_i2c, (0x20), (0x0A), data_w, 1);};
# 357 "../src/extensions/analogio-x8.xc"
    { unsigned char data_w[1]; data_w[0] = 0b00001100; AKM_i2c_shared_master_write_reg(r_i2c, (0x20), (0x0B), data_w, 1);};
# 366 "../src/extensions/analogio-x8.xc"
    { unsigned char data_w[1]; data_w[0] = 0b00000000; AKM_i2c_shared_master_write_reg(r_i2c, (0x20), (0x0C), data_w, 1);};
# 375 "../src/extensions/analogio-x8.xc"
    { unsigned char data_w[1]; data_w[0] = 0b00000000; AKM_i2c_shared_master_write_reg(r_i2c, (0x20), (0x0D), data_w, 1);};





    { unsigned char data_w[1]; data_w[0] = 0b01010000; AKM_i2c_shared_master_write_reg(r_i2c, (0x20), (0x0E), data_w, 1);};
# 390 "../src/extensions/analogio-x8.xc"
    { unsigned char data_w[1]; data_w[0] = 0b00000101; AKM_i2c_shared_master_write_reg(r_i2c, (0x20), (0x00), data_w, 1);};

    unsigned char data[1] = {0};
    data[0] = 0x00;
    { AKM_i2c_shared_master_read_reg(r_i2c, (0x20), (0x0E), data, 1);};

    { AKM_i2c_shared_master_read_reg(r_i2c, (0x20), (0x00), data, 1);};
