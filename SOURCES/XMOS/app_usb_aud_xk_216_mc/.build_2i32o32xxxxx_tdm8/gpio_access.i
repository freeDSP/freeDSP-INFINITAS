# 1 "../src/extensions/gpio_access.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 289 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/extensions/gpio_access.c" 2
...
# 5 ".././src/extensions/gpio_access.h" 2
...
# 2 "../src/extensions/gpio_access.c" 2
...
# 3 "../src/extensions/gpio_access.c" 2
...
# 4 "../src/extensions/gpio_access.c" 2
...
void set_gpio(unsigned bit, unsigned value)
{
 ...
 port_shadow = p_gpio_peek();
 if (value == 0) port_shadow &= ~bit;
 else port_shadow |= bit;
 p_gpio_out(port_shadow);
}
