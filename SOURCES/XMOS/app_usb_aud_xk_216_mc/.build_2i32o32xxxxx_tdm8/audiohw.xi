...
# 40 "../src/extensions/audiohw.xc" 2
# 116 "../src/extensions/audiohw.xc"
...
{
# 135 "../src/extensions/audiohw.xc"
    i2c_shared_master_init(r_i2c);


    set_gpio((1 << 1), 0);
    set_gpio((1 << 6), 0);
# 148 "../src/extensions/audiohw.xc"
    set_gpio((1 << 2), 1);
    set_gpio((1 << 3), 1);
# 175 "../src/extensions/audiohw.xc"
}
...
# 219 "../src/extensions/audiohw.xc"
    ...
    i2c_shared_master_write( r_i2c, (0xE4)>>1, data, 1 );
# 243 "../src/extensions/audiohw.xc"
    data[0] = (0x08);
    i2c_shared_master_write( r_i2c, (0xE4)>>1, data, 1 );
