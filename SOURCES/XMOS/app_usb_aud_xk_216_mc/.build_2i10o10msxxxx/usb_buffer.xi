...
# 8 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/usb_buffer/usb_buffer.xc" 2
...
# 63 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/usb_buffer/usb_buffer.xc"
...
static unsigned int g_midi_to_host_buffer_A[(256)/4];
static unsigned int g_midi_to_host_buffer_B[(256)/4];
static unsigned int g_midi_from_host_buffer[1024/4];
            ...
            case testct_byref(c_aud_ctl, u_tmp):
            {
                ...
                else
                {
                    ...
                    else if (cmd == 8)
                    {
                        ...
                        asm volatile("stw %0, dp[" "g_formatChange_DataFormat" "]"::"r"(formatChange_DataFormat):"memory");
                        asm volatile("stw %0, dp[" "g_formatChange_SampRes" "]"::"r"(formatChange_SampRes):"memory");
# 386 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/usb_buffer/usb_buffer.xc"
                    }
...
# 477 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/usb_buffer/usb_buffer.xc"
            ...
            break;
# 576 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/usb_buffer/usb_buffer.xc"
        ...
        case XUD_GetData_Select(c_midi_from_host, ep_midi_from_host, length, result):
            ...
            if((result == XUD_RES_OKAY) && (length > 0))
            {
                ...
                {
                    asm("ldw %0, %1[0]":"=r"(datum):"r"(midi_from_host_rdptr));;
                    __builtin_out_uint(c_midi, datum);
