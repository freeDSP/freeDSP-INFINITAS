...
# 170 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/endpoint0/descriptors.h"
    char *inputChanStr_1;
...
# 318 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/endpoint0/descriptors.h"
    ...
    .midiOutStr = "XMOS"" ""MIDI Out",
    .midiInStr = "XMOS"" ""MIDI In",
...
# 325 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/endpoint0/chanstrings.h"
    ...
    .outputChanStr_9 = ""
# 338 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/endpoint0/chanstrings.h"
            "SPDIF 1"
# 365 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/endpoint0/chanstrings.h"
    ...
    .outputChanStr_10 = ""
# 380 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/endpoint0/chanstrings.h"
            "SPDIF 2"
# 405 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/endpoint0/chanstrings.h"
        ,
# 1292 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/endpoint0/chanstrings.h"
    .inputChanStr_1 = ""
...
# 723 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/endpoint0/descriptors.h"
    unsigned char configDesc_Midi[(92)];
...
# 945 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/endpoint0/descriptors.h"
        .Audio_Out_FeatureUnit =
        {
...

            {
                ...
                0x0000000F,
# 1058 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/endpoint0/descriptors.h"
            },
            0,
        },
...
# 1121 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/endpoint0/descriptors.h"
        .Audio_In_FeatureUnit =
        {
...

            {
                ...
                0x0000000F,
# 1233 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/endpoint0/descriptors.h"
            },
            0,
        },
...
# 1365 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/endpoint0/descriptors.h"
    ...
    .Audio_Out_Endpoint =
    {
        ...
        .bmAttributes = 0x05,
        .wMaxPacketSize = ((((((192000)+7999)/8000)+1) * (10)) * 4),
        .bInterval = 1,
    },
...
# 1464 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/endpoint0/descriptors.h"
    ...
    .Audio_Out_Endpoint_2 =
    {
        ...
        .bEndpointAddress = (ENDPOINT_NUMBER_OUT_AUDIO),
        .bmAttributes = 0x05,
        .wMaxPacketSize = ((((((192000)+7999)/8000)+1) * (10)) * (16/8)),
        .bInterval = 1,
    },
...
# 1848 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/endpoint0/descriptors.h"
    {0x09,
    0x04,
    INTERFACE_NUMBER_MIDI_CONTROL,
    0x00,
    ...
    0x02,
    0x02,
    __builtin_offsetof(StringDescTable_t, midiInStr)/sizeof(char *),
    ...
    0x01,
    0x01,
    __builtin_offsetof(StringDescTable_t, midiOutStr)/sizeof(char *),
...
int volsOut[(10) + 1];
unsigned int mutesOut[(10) + 1];


int volsIn[(10) + 1];
unsigned int mutesIn[(10) + 1];
...
unsigned char channelMap[(10) + (10) + 0];
unsigned char channelMapAud[(10)];
unsigned char channelMapUsb[(10)];
...
const unsigned g_chanCount_In_HS[1] = {(10),
...
# 650 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/endpoint0/endpoint0.c"
                if(g_curUsbSpeed == XUD_SPEED_HS)
                {
                    ...
                    cfgDesc_Audio2.Audio_Out_Endpoint.wMaxPacketSize = ((((((192000)+7999)/8000)+1) * (10)) * 4);
                    ...
                    cfgDesc_Audio2.Audio_Out_Endpoint_2.wMaxPacketSize = ((((((192000)+7999)/8000)+1) * (10)) * (16/8));
...
# 676 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/endpoint0/endpoint0.c"
                    ...
                    cfgDesc_Audio2.Audio_In_Endpoint.wMaxPacketSize = ((((((192000)+7999)/8000)+1) * (10)) * 4);
