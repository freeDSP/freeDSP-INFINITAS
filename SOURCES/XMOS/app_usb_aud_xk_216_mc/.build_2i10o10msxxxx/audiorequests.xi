...
extern unsigned int multOut[(10) + 1];
extern unsigned int multIn[(10) + 1];
...
extern unsigned char channelMapAud[(10)];
extern unsigned char channelMapUsb[(10)];
                    ...
                    switch( sp.wValue >> 8 )
                    {
                        case 0x01:
...

                            {
                                ...
                                {
                                    if((lowSampleRateList[k] >= (48000)) && (lowSampleRateList[k] <= (192000)))
                                    {
