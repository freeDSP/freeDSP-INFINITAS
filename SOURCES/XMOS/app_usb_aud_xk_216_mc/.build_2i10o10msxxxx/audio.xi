...
# 1 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_spdif_tx/src/SpdifTransmit.h" 1
# 36 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_spdif_tx/src/SpdifTransmit.h"
void SpdifTransmit(buffered out port:32 p, chanend c);
# 47 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_spdif_tx/src/SpdifTransmit.h"
void SpdifTransmitPortConfig(out buffered port:32 p, __clock_t cl, in port p_mclk);
# 23 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/audio.xc" 2
...
static unsigned samplesOut[(10)];


static unsigned samplesIn_0[(10)];
static unsigned samplesIn_1[(8)];
...
extern buffered out port:32 p_i2s_dac[((8) / 2)];



extern buffered in port:32 p_i2s_adc[((8) / 2)];
...
# 646 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/audio.xc"
            p_lrclk <: 0x80000000;
...
#pragma loop unroll
 ...
 for(int i = 0; i < (8); i+=2)
        ...
        if(frameCount == 0)
        {
# 702 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/audio.xc"
            __builtin_out_uint(c_spd_out, samplesOut[(8)]);
            unsigned sample = samplesOut[(8) + 1];
            __builtin_out_uint(c_spd_out, sample);
...
# 753 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/audio.xc"
            p_lrclk <: 0x7FFFFFFF;
...
# 826 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/audio.xc"
        {
...
# 1027 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/audio.xc"
...
# 1184 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/audio.xc"
            {
                ...
                __builtin_out_uint(c_spdif_out, curSamFreq);
                __builtin_out_uint(c_spdif_out, mClk);
                ...
                if (curSamFreq == (0x12345678))
    {
                   ...
                   while (1)
     {
                     ...
                     if (curSamFreq == (0x87654321))
      {
                ...
                __builtin_outct(c_spdif_out, 0x1);
