...
# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/syscall.h" 1 3
# 48 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/syscall.h" 3
...
# 98 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/syscall.h" 3
...
# 5 "/Users/rkn/Documents/xTIMEcomposer/workspace/app_usb_aud_xk_216_mc/.build_2i10o10msxxxx/xk-audio-216-mc.h" 2 3
...
# 1 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 1 3
# 38 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
typedef enum {
  XSCOPE_STARTSTOP=1,
  XSCOPE_CONTINUOUS,
  XSCOPE_DISCRETE,
...
# 77 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
...
# 116 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_short(unsigned char id, unsigned short data);
# 127 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_int(unsigned char id, unsigned int data);
# 138 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_longlong(unsigned char id, unsigned long long data);
# 149 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_float(unsigned char id, float data);
# 160 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_double(unsigned char id, double data);
# 172 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_bytes(unsigned char id, unsigned int size, const unsigned char data[]);
# 182 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_start(unsigned char id);
# 192 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_stop(unsigned char id);
# 203 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_start_int(unsigned char id, unsigned int data);
# 214 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_stop_int(unsigned char id, unsigned int data);
# 225 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_core_char(unsigned char id, unsigned char data);
# 236 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_core_short(unsigned char id, unsigned short data);
# 247 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_core_int(unsigned char id, unsigned int data);
# 258 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_core_longlong(unsigned char id, unsigned long long data);
# 269 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_core_float(unsigned char id, float data);
# 280 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_core_double(unsigned char id, double data);
# 292 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_core_bytes(unsigned char id, unsigned int size, const unsigned char data[]);
# 302 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_core_start(unsigned char id);
# 312 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_core_stop(unsigned char id);
# 324 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_core_start_int(unsigned char id, unsigned int data);
# 336 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
void xscope_core_stop_int(unsigned char id, unsigned int data);
# 345 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
...
# 420 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 3
# 1 "/Users/rkn/Documents/xTIMEcomposer/workspace/app_usb_aud_xk_216_mc/.build_2i10o10msxxxx/xscope_probes.h" 1 3
# 420 "/Applications/XMOS_xTIMEcomposer_Community_14.3.2/target/include/xscope.h" 2 3
...
# 24 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/main.xc" 2
...
on tile[0] : buffered out port:32 p_i2s_dac[((8) / 2)] =
                {on tile[0]: 0x10c00,
...
on tile[0] : buffered in port:32 p_i2s_adc[((8) / 2)] =
                {on tile[0]: 0x10a00,
...
on tile[0] : buffered out port:32 p_spdif_tx = on tile[0]: 0x10300;
# 147 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/main.xc"
on tile[1] : port p_midi_tx = on tile[1]: 0x10d00;




on tile[1] : buffered in port:1 p_midi_rx = on tile[1]: 0x10c00;





on tile[1] : __clock_t clk_midi = 0x6;;



on tile[0] : __clock_t clk_mst_spd = 0x106;
...
XUD_EpType epTypeTableIn[ENDPOINT_COUNT_IN] = { XUD_EPTYPE_CTL | 0x80000000,
                                            XUD_EPTYPE_ISO,
# 236 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/main.xc"
                                            XUD_EPTYPE_BUL,
...
# 615 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/main.xc"
        on tile[1]:
        {
            thread_speed();
