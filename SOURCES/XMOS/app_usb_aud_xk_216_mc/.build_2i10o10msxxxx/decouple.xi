...
unsigned int multOut[(10) + 1];
static xc_ptr p_multOut;


unsigned int multIn[(10) + 1];
static xc_ptr p_multIn;



unsigned g_numUsbChan_Out = (10);
unsigned g_numUsbChan_In = (10);
# 54 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/usb_buffer/decouple.xc"
unsigned outAudioBuff[((4 * (((((192000)+7999)/8000))+3) * (10))>(4 * ((((48000 +999)/1000))+3) * (2)) ? (4 * (((((192000)+7999)/8000))+3) * (10)) : (4 * ((((48000 +999)/1000))+3) * (2))) + (1028>>2) + 4];
unsigned audioBuffIn[((4 * (((((192000)+7999)/8000))+3) * (10))>(4 * ((((48000 +999)/1000))+3) * (2)) ? (4 * (((((192000)+7999)/8000))+3) * (10)) : (4 * ((((48000 +999)/1000))+3) * (2))) + ((((((48000/1000+1)*(2)*4))>((((192000)/8000+1)*(10)*4)) ? (((48000/1000+1)*(2)*4)) : ((((192000)/8000+1)*(10)*4))))>>2) + 4];

unsigned inZeroBuff[((((((48000/1000+1)*(2)*4))>((((192000)/8000+1)*(10)*4)) ? (((48000/1000+1)*(2)*4)) : ((((192000)/8000+1)*(10)*4))))>>2)+4];
...
int g_maxPacketSize = (((192000)/8000+1)*(10)*4);
...
#pragma xta endpoint "out_underflow"
 ...
 for(int i = 0; i < (10); i++)
        ...
        if (outSamps < 0)
        {
            outSamps += ((4 * (((((192000)+7999)/8000))+3) * (10))>(4 * ((((48000 +999)/1000))+3) * (2)) ? (4 * (((((192000)+7999)/8000))+3) * (10)) : (4 * ((((48000 +999)/1000))+3) * (2)))*4;
        }


        if(outSamps >= (((((2)*((((48000 +999)/1000))+3)*3+4)>((10)*(((((192000)+7999)/8000))+3)*4+4) ? ((2)*((((48000 +999)/1000))+3)*3+4) : ((10)*(((((192000)+7999)/8000))+3)*4+4))*1)))
        {
            outUnderflow = 0;
            outSamps++;
        }
...
#pragma xta endpoint "mixer_request"
 int sample;
        ...
        for(int i = 0; i < (10) - g_numUsbChan_Out; i++)
        {
...
# 354 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/usb_buffer/decouple.xc"
        ...
        for(int i = 0; i < (10) - g_numUsbChan_In; i++)
        {
...
# 470 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/usb_buffer/decouple.xc"
            ...
            if((space_left < (totalSampsToWrite * g_numUsbChan_In * g_curSubSlot_In + 4)))
            {
                ...
                } while(space_left < (((4 * (((((192000)+7999)/8000))+3) * (10))>(4 * ((((48000 +999)/1000))+3) * (2)) ? (4 * (((((192000)+7999)/8000))+3) * (10)) : (4 * ((((48000 +999)/1000))+3) * (2)))*4/2));
            }
...
)
{
    ...
    aud_from_host_fifo_end = aud_from_host_fifo_start + ((4 * (((((192000)+7999)/8000))+3) * (10))>(4 * ((((48000 +999)/1000))+3) * (2)) ? (4 * (((((192000)+7999)/8000))+3) * (10)) : (4 * ((((48000 +999)/1000))+3) * (2)))*4;
    ...
    aud_to_host_fifo_end = aud_to_host_fifo_start + ((4 * (((((192000)+7999)/8000))+3) * (10))>(4 * ((((48000 +999)/1000))+3) * (2)) ? (4 * (((((192000)+7999)/8000))+3) * (10)) : (4 * ((((48000 +999)/1000))+3) * (2)))*4;
    g_aud_to_host_wrptr = aud_to_host_fifo_start;
...
# 810 "/Users/rkn/Documents/xTIMEcomposer/workspace/module_usb_audio/usb_buffer/decouple.xc"
        ...
        else if (outOverflow)
        {
            ...
            space_left = aud_from_host_rdptr - aud_from_host_wrptr;
            if (space_left <= 0)
                space_left += ((4 * (((((192000)+7999)/8000))+3) * (10))>(4 * ((((48000 +999)/1000))+3) * (2)) ? (4 * (((((192000)+7999)/8000))+3) * (10)) : (4 * ((((48000 +999)/1000))+3) * (2)))*4;
            if (space_left >= (((4 * (((((192000)+7999)/8000))+3) * (10))>(4 * ((((48000 +999)/1000))+3) * (2)) ? (4 * (((((192000)+7999)/8000))+3) * (10)) : (4 * ((((48000 +999)/1000))+3) * (2)))*4/2))
            {
...

        {
            ...
            if (tmp)
            {
                ...
                if (inUnderflow)
                {
                    ...
                    if (fill_level < 0)
                        fill_level += ((4 * (((((192000)+7999)/8000))+3) * (10))>(4 * ((((48000 +999)/1000))+3) * (2)) ? (4 * (((((192000)+7999)/8000))+3) * (10)) : (4 * ((((48000 +999)/1000))+3) * (2)))*4;
