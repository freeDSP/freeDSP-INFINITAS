/*
 * File:           E:\Documents\KiCAD\projekte\freeDSP\freeDSP-Infinitas\SOURCES\SIGMASTUDIO\testproject\testproject_HW_IC_1.h
 *
 ...
 */
#ifndef __TESTPROJECT_HW_IC_1_H__
#define __TESTPROJECT_HW_IC_1_H__

#include "SigmaStudioFW.h"
#include "testproject_HW_IC_1_REG.h"
...
ADI_REG_TYPE R16_PANIC_PARITY_MASK_IC_1_Default[REG_PANIC_PARITY_MASK_IC_1_BYTE] = {
0x00, 0x03
};
...
ADI_REG_TYPE R30_SERIAL_BYTE_4_0_IC_1_Default[REG_SERIAL_BYTE_4_0_IC_1_BYTE] = {
0x90, 0x4A
};

/* Register Default - IC 1.KILL_CORE */
ADI_REG_TYPE R34_KILL_CORE_IC_1_Default[REG_KILL_CORE_IC_1_BYTE] = {
0x00, 0x00
};

/* Register Default - IC 1.START_ADDRESS */
ADI_REG_TYPE R35_START_ADDRESS_IC_1_Default[REG_START_ADDRESS_IC_1_BYTE] = {
0x00, 0x00
};

/* Register Default - IC 1.START_PULSE */
ADI_REG_TYPE R36_START_PULSE_IC_1_Default[REG_START_PULSE_IC_1_BYTE] = {
0x00, 0x02
};

/* Register Default - IC 1.START_CORE */
ADI_REG_TYPE R37_START_CORE_IC_1_Default[REG_START_CORE_IC_1_BYTE] = {
0x00, 0x00
};
...
#define R39_START_DELAY_IC_1_ADDR 0x0
#define R39_START_DELAY_IC_1_SIZE 2
ADI_REG_TYPE R39_START_DELAY_IC_1_Default[R39_START_DELAY_IC_1_SIZE] = {
0x00, 0x01
};

/* Register Default - IC 1.HIBERNATE */
ADI_REG_TYPE R40_HIBERNATE_IC_1_Default[REG_HIBERNATE_IC_1_BYTE] = {
0x00, 0x00
};
...
void default_download_IC_1() {
	...
	SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_IC_1, REG_PANIC_PARITY_MASK_IC_1_ADDR, REG_PANIC_PARITY_MASK_IC_1_BYTE, R16_PANIC_PARITY_MASK_IC_1_Default );
	...
	SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_IC_1, REG_SERIAL_BYTE_4_0_IC_1_ADDR, REG_SERIAL_BYTE_4_0_IC_1_BYTE, R30_SERIAL_BYTE_4_0_IC_1_Default );
	...
	SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_IC_1, REG_KILL_CORE_IC_1_ADDR, REG_KILL_CORE_IC_1_BYTE, R34_KILL_CORE_IC_1_Default );
	SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_IC_1, REG_START_ADDRESS_IC_1_ADDR, REG_START_ADDRESS_IC_1_BYTE, R35_START_ADDRESS_IC_1_Default );
	SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_IC_1, REG_START_PULSE_IC_1_ADDR, REG_START_PULSE_IC_1_BYTE, R36_START_PULSE_IC_1_Default );
	SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_IC_1, REG_START_CORE_IC_1_ADDR, REG_START_CORE_IC_1_BYTE, R37_START_CORE_IC_1_Default );
	...
	SIGMA_WRITE_DELAY( DEVICE_ADDR_IC_1, R39_START_DELAY_IC_1_SIZE, R39_START_DELAY_IC_1_Default );
	SIGMA_WRITE_REGISTER_BLOCK( DEVICE_ADDR_IC_1, REG_HIBERNATE_IC_1_ADDR, REG_HIBERNATE_IC_1_BYTE, R40_HIBERNATE_IC_1_Default );
}
